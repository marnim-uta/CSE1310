...
// Question 18
/* Update A, B, C values in the code below to get the following expected output 
...
int main(){
    int A = ?; // replace ? with possible value of A
    int B = ?; // replace ? with possible value of B
    int C = ?; // replace ? with possible value of C
    for (int i = A; i > 15; i--){
